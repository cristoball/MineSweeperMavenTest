...
{
	public ExpertView(int width, int height, int nMineCount, GridSpaceObserver observer, GameButtonObserver gameBtnObserver)
	{
	...
	public void createNewGameView()
	{
		...
		this.setMinimumSize(new Dimension(810, 516));
